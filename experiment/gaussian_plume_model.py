...
output=PLAN_VIEW;
x_slice=50; # position (1-50) to take the slice in the x-direction
y_slice=50;  # position (1-50) to plot concentrations vs time
...
Q=[70., 80., 100.]; # mass emitted per unit time
H=[80., 50., 50.]; # stack height, m
