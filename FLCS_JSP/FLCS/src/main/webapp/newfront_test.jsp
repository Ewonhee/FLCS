...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="./css/practice2">
    <link rel="stylesheet" media="only screen and (min-width:200px) and (max-width:480px)" href="./css/practice2">
      ...
      <ul>
        ...
        <ul class="menu1">
          ...
          <div class="menu1_dateTime">
            <div id="form">
              <p><input id="date" type="date" min="2022-03-21" max="2022-11-01"required></p>
              <p><input id="time" type="time" required></p>
              <p><input id="submitId" type="button" onclick="input()" value="Ok"></p>
            </div>
          </details>
          </div>
        </ul>       
        ...
        <ul class="menu4">
          ...
          <div class="menu4_dateTime">
              <div id="form">
                <p><input id="ddate" type="date" min="2022-03-21" max="2022-11-01"required></p>
                <p><input id="dtime" type="time" required></p>
              </div>
            <a href="/2022_3_21-6_SUOMI_VIIRS_C2result_koreaEPSG.txt" id="pt" download="test.txt" onclick="dinput()">다운로드</a>
          </details>
          </div>
        </ul>
      </ul> 
...
<%@ include file="dbconn.jsp"%>
   ...
   try {
      String sql = "SELECT * FROM crdnttable";
      ...
      while (rs.next()) {
         ...
         String coorX = rs.getString("crdnt_X");
         sb.append(coorX + ",");
         String coorY = rs.getString("crdnt_Y");
         sb.append(coorY + "],");
      }
...
<script>
 ...
 function input() {
         ...
         var time = document.querySelector("#time").value.slice(0,2);
         console.log(date+" "+time);
      }

 function dinput() {
   var ddate = document.querySelector("#ddate").value;
   var dtime = document.querySelector("#dtime").value.slice(0,2);

   document.getElementById('pt').setAttribute("download", ddate+"-"+dtime);

   console.log(ddate+" "+dtime);
      }
