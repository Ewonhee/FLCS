					...
					<ul class="menu1">
						<details>
							...
							<div class="menu1_dateTime">
								<form action="FLCS_Main.jsp" method="get">
									<div id="form">
										<p>
					...
					<ul class="menu2">
						<details>
							...
							<div class="menu2_dateTime">
								...
								<a href="" id="pt" download="" onclick="dinput()">다운로드</a>
							</div>
						</details>
					</ul>
					<ul class="menu3">
						<p style="font-size: 9px; vertical-align: bottom; text-align: center;"><%=sCondition2%></p>
						<p style="font-size: 9px; vertical-align: bottom; text-align: center;"><%=sCondition3%>시
						</p>
						<p style="font-size: 9px; vertical-align: bottom; text-align: center;">
							산불<%=num_data%>개
						</p>
					</ul>
				</ul>
