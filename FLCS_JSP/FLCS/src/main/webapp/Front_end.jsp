				...
				<ul class="menu1">
					<details>
						...
						<div class="menu1_dateTime">
							<div id="form">
								<p>
									<input id="date" type="date" min="2022-03-21" max="2022-11-01" required>
								</p>
								<p>
									<input id="time" type="time" required>
								</p>
								<p>
									<input id="submitId" type="button" onclick="input()" value="Ok">
								</p>
							</div>
					</details>
					</div>
					...
					<details>
						...
						<div class="menu4_dateTime">
							<form action="test.jsp">
								<p>
									<input id="ddate" type="date" min="2022-03-01" max="2022-11-01" required>
								</p>
								<p>
									<input id="dtime" type="time" required>
								</p>
								<p>
									<input id="submitd" type="submit" value="download">
								</p>
							</form>
						</div>
					</details>
